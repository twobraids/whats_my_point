...
# WARNING - this script makes almost 400 images for assembly into a video
...
def draw_a_looping_spiral(a_canvas):
    ...
    larger_rotator_iter = iter_natural_steps_between(
    ...
    smaller_rotator_iter = iter_natural_steps_between(
